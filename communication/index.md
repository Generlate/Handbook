...
-   [Decision making at Generlate](decisions.md) <!-- missing link -->
...
-   [Discord](team_chat.md) <!-- missing link -->
-   [Requests for comments (RFCs)](rfcs/index.md) <!-- missing link -->
-   Email
-   Video recordings
-   Meeting notes
-   All other Google Docs/Sheets/Slides <!-- change this to Word?/microsoft 365? -->

## Meetings

-   [Company meeting](company_meeting.md) (Mondays 8:00-8:30am PST/PDT) <!-- missing link -->
-   [Social calendar](../company/remote/social_calendar.md) meetings <!-- missing link -->
...
1. Google Calendar <!-- change google calendar to outlook or apple --> has a <!-- change to discord plugin --> [Zoom plugin](https://chrome.google.com/webstore/detail/zoom-scheduler/kgjfgplpablkjnlkjmjdecgdpfankdle?hl=en-US) where you can easily add a Discord link for a video call to the invite.
...
1. In your [Discord settings](https://discord.com/profile/setting), <!-- link is broken --> enable "Join before host". (It is enabled by default in our Discord organization account, but you may have overridden it previously.) This lets the meeting get started even if you aren't there.
...
## [1-1 meetings](../leadership/1-1.md) <!-- missing link -->

See "[1-1 meetings](../leadership/1-1.md)". <!-- missing link -->

## [Announcements](announcements.md) <!-- missing link -->

See "[Announcements](announcements.md)". <!-- missing link -->
...
-   [srcgr.ph](http://srcgr.ph/) <!-- this is and goes to sourcegraph -->

We also use [srcgr.ph](http://srcgr.ph/) as our Bitly custom URL. <!-- this is and goes to sourcegraph -->
...
1. The [shared Generlate Drive](https://drive.google.com/drive/folders/0AK4DcztHds_pUk9PVA) <!-- change to OneDrive or P4V or something --> folder on OneDrive is visible and editable by all Generlate team members.
...
### Deprecating a Google Doc <!-- change this microsoft 365, onedrive or p4v -->

Deprecate a Google Doc <!-- change this to microsoft word or Blender --> when all of its content is added to the handbook, blog, or documentation (or other [source of truth](#sources-of-truth)). This lets people know to not consult, edit, or comment on it anymore.

1. Rename the Google Doc <!-- change to word or blender --> to `DEPRECATED - <previous doc title>`.
...
-   [Seeking and giving feedback](./seeking-and-giving-feedback.md) <!-- missing link -->

## Handling conflicts

-   [Conflict resolution](./conflicts.md) <!-- missing link -->
-   [Clean escalation](./conflicts.md#clean-resolution) <!-- missing link -->
-   [Customer ethics policy](customer_ethics.md) <!-- missing link -->
...
7. You may wish to add another line like `What is Building Generation?` with links to https://www.generlate.com/about
